...
.btn{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;padding:14px;color:#fff;text-decoration:none;font-weight:700;font-size:15px;border-radius:12px;cursor:pointer;border:none;margin-bottom:10px}
    ...
    .btn-dl{background:#f59e0b;color:#0f172a}
...
<div class="info">
      ...
      ${appDownloadUrl ? `
      <a id="btn-download" class="btn btn-dl" href="${escapeHtml(appDownloadUrl)}" style="display:none">
  ...
  <script>
    ...
    // Show "Download App" button after 1.5s — by then the intent would have
    // opened the app if installed. If the page is still visible, app isn't installed.
